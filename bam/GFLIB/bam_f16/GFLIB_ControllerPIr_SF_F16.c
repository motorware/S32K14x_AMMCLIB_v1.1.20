/**
 * GFLIB_ControllerPIr_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16  y1 = GFLIB_ControllerPIr_w_F16(int16 u1, GFLIB_CONTROLLER_PI_R_T_F16 work1[1], int16 work2[1], int16 u2, int16 u3, int16 u4, int32 u5, int16 u6, uint16 u7, int32 y2[1], int16 y3[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:02:29
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_ControllerPIr_SF_F16
...
#include "gflib.h"
#include "GFLIB_ControllerPIr_w.h"
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GFLIB_CONTROLLER_PI_R_T_F16", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_ControllerPIrInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GFLIB_ControllerPIr_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIrInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIr_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIr_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIr_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GFLIB_CONTROLLER_PI_R_T_F16Id = ssGetDataTypeId(S, "GFLIB_CONTROLLER_PI_R_T_F16");
        ...
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PI_R_T_F16Id);
        ...
        /* Get information for accessing GFLIB_CONTROLLER_PI_R_T_F16.f16CC1sc */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PI_R_T_F16Id, 0);
        __dtBusInfo[1] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PI_R_T_F16.f16CC2sc */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PI_R_T_F16Id, 1);
        __dtBusInfo[3] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PI_R_T_F16.f32Acc */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PI_R_T_F16Id, 2);
        __dtBusInfo[5] = __dtSizeInfo[2];

        /* Get information for accessing GFLIB_CONTROLLER_PI_R_T_F16.f16InErrK1 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PI_R_T_F16Id, 3);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PI_R_T_F16.u16NShift */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PI_R_T_F16Id, 4);
        __dtBusInfo[9] = __dtSizeInfo[3];


        /* Alloc memory for the pwork 1 (__work1BUS) */
        {
            GFLIB_CONTROLLER_PI_R_T_F16* __work1BUS = (GFLIB_CONTROLLER_PI_R_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PI_R_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PI_R_T_F16* __work1BUS = (GFLIB_CONTROLLER_PI_R_T_F16*) ssGetPWorkValue(S, 0);
        ...
        GFLIB_ControllerPIrInit_w_F16(*p3, *p4, *p5, __work1BUS, work2, *p2);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GFLIB_ControllerPIr_w_F16(*u1, __work1BUS, work2, *u2, *u3, *u4, *u5, *u6, *u7, y2, y3, *p1, *p2);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GFLIB_CONTROLLER_PI_R_T_F16', specification */
    {
        uint32_T chk[] = {210305161, 1281208834, 1932844948, 3329523204};
        int_T status;
        status = CheckDataTypeChecksum(S, "GFLIB_CONTROLLER_PI_R_T_F16", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GFLIB_CONTROLLER_PI_R_T_F16'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GFLIB_CONTROLLER_PI_R_T_F16' definition has changed since the S-Function was generated");
        }
    }
}
