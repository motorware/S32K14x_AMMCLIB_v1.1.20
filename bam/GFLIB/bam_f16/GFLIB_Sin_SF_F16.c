 ...
 *
 *         int16 y1 = GFLIB_Sin_w_F16(int16 u1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:04:06
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_Sin_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_Sin_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
