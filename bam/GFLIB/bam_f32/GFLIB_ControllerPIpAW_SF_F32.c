/**
 * GFLIB_ControllerPIpAW_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32 y1 = GFLIB_ControllerPIpAW_w_F32(int32 u1, GFLIB_CONTROLLER_PIAW_P_T_F32 work1[1], int32 work2[1], int32 u2, int32 u3, int32 u4, int16 u5, int16 u6, int32 u7, int32 u8, int32 u9, int32 u10, uint16 y2[1], int32 y3[1], int32 y4[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:01:52
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_ControllerPIpAW_SF_F32
...
#include "gflib.h"
#include "GFLIB_ControllerPIpAW_w.h"
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_ControllerPIpAWInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GFLIB_ControllerPIpAW_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIpAWInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIpAW_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIpAW_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIpAW_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_P_T_F32Id);
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PIAW_P_T_F32* __work1BUS = (GFLIB_CONTROLLER_PIAW_P_T_F32*) ssGetPWorkValue(S, 0);
        ...
        (void) memcpy(&__work1BUS[0].f32LowerLimit, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].f32UpperLimit, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work1BUS[0].f32IntegPartK_1, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].f32InK_1, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].u16LimitFlag, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);

        /* Call the legacy code function */
        GFLIB_ControllerPIpAWInit_w_F32(*p3, *p4, *p5, *p6, *p7, *p8, __work1BUS, work2, *p2);
        ...
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].f32LowerLimit,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].f32UpperLimit,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].f32IntegPartK_1,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].f32InK_1,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].u16LimitFlag,  __dtBusInfo[17]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GFLIB_ControllerPIpAW_w_F32(*u1, __work1BUS, work2, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, y2, y3, y4, *p1, *p2);
