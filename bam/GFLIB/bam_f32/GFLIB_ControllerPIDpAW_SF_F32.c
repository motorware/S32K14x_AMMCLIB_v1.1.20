/**
 * GFLIB_ControllerPIDpAW_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32  y1 = GFLIB_ControllerPIDpAW_w_F32(int32 u1,  GFLIB_CONTROLLER_PID_P_AW_T_F32 work1[1], int32 work2[1], int32 u2, int32 u3, int32 u4, int32 u5, int32 u6, int16 u7, int16 u8, int16 u9, int32 u10, int32 u11, int32 u12, int32 u13, int32 u14, uint16 y2[1], int32 y3[1], int32 y4[1], int32 y5[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:01:37
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_ControllerPIDpAW_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GFLIB_CONTROLLER_PID_P_AW_T_F32", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_ControllerPIDpAWInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GFLIB_ControllerPIDpAW_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIDpAWInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIDpAW_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIDpAW_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIDpAW_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GFLIB_CONTROLLER_PID_P_AW_T_F32Id = ssGetDataTypeId(S, "GFLIB_CONTROLLER_PID_P_AW_T_F32");
        ...
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id);
        ...
        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32PropGain */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 0);
        __dtBusInfo[1] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32IntegGain */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 1);
        __dtBusInfo[3] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32DerivGain */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 2);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32FiltCoef */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 3);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.s16PropGainShift */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 4);
        __dtBusInfo[9] = __dtSizeInfo[2];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.s16IntegGainShift */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 5);
        __dtBusInfo[11] = __dtSizeInfo[2];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.s16DerivGainShift */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 6);
        __dtBusInfo[13] = __dtSizeInfo[2];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32LowerLimit */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 7);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32UpperLimit */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 8);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32IntegPartK_1 */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 9);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32DerivPartK_1 */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 10);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.f32InK_1 */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 11);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PID_P_AW_T_F32.u16LimitFlag */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PID_P_AW_T_F32Id, 12);
        __dtBusInfo[25] = __dtSizeInfo[3];


        /* Alloc memory for the pwork 1 (__work1BUS) */
        {
            GFLIB_CONTROLLER_PID_P_AW_T_F32* __work1BUS = (GFLIB_CONTROLLER_PID_P_AW_T_F32*)calloc(sizeof(GFLIB_CONTROLLER_PID_P_AW_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PID_P_AW_T_F32* __work1BUS = (GFLIB_CONTROLLER_PID_P_AW_T_F32*) ssGetPWorkValue(S, 0);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f32PropGain, work1 +  __dtBusInfo[0],  __dtBusInfo[1]);
        (void) memcpy(&__work1BUS[0].f32IntegGain, work1 +  __dtBusInfo[2],  __dtBusInfo[3]);
        (void) memcpy(&__work1BUS[0].f32DerivGain, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].f32FiltCoef, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        ...
        (void) memcpy(&__work1BUS[0].f32LowerLimit, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].f32UpperLimit, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].f32IntegPartK_1, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work1BUS[0].f32DerivPartK_1, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work1BUS[0].f32InK_1, work1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work1BUS[0].u16LimitFlag, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);

        /* Call the legacy code function */
        GFLIB_ControllerPIDpAWInit_w_F32(*p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, __work1BUS, work2, *p2);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[0], &__work1BUS[0].f32PropGain,  __dtBusInfo[1]);
        (void) memcpy(work1 +  __dtBusInfo[2], &__work1BUS[0].f32IntegGain,  __dtBusInfo[3]);
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f32DerivGain,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f32FiltCoef,  __dtBusInfo[7]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].f32LowerLimit,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].f32UpperLimit,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].f32IntegPartK_1,  __dtBusInfo[19]);
        (void) memcpy(work1 +  __dtBusInfo[20], &__work1BUS[0].f32DerivPartK_1,  __dtBusInfo[21]);
        (void) memcpy(work1 +  __dtBusInfo[22], &__work1BUS[0].f32InK_1,  __dtBusInfo[23]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GFLIB_ControllerPIDpAW_w_F32(*u1, __work1BUS, work2, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, y2, y3, y4, y5, *p1, *p2);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GFLIB_CONTROLLER_PID_P_AW_T_F32', specification */
    {
        uint32_T chk[] = {1963962556, 849465572, 2719465374, 2937867298};
        int_T status;
        status = CheckDataTypeChecksum(S, "GFLIB_CONTROLLER_PID_P_AW_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GFLIB_CONTROLLER_PID_P_AW_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GFLIB_CONTROLLER_PID_P_AW_T_F32' definition has changed since the S-Function was generated");
        }
    }
}
