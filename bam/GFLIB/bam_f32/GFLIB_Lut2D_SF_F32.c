/**
 * GFLIB_Lut2D_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32  y1 = GFLIB_Lut2D_w_F32(int32 u1, int32 u2, uint32 u3, uint32 u4, int32 p1[][], int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:03:33
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_Lut2D_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_Lut2D_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = GFLIB_Lut2D_w_F32(*u1, *u2, *u3, *u4, p1, *p2);
}
