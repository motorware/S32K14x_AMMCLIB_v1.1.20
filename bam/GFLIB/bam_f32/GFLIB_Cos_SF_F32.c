 ...
 *
 *         int32 y1  = GFLIB_Cos_w_F32(int32 u1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:02:37
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_Cos_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_Cos_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
