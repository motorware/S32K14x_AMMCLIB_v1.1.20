/**
 * GFLIB_Lut2D_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = GFLIB_Lut2D_w_FLT(single u1, single u2, uint32 u3, uint32 u4, single p1[][], int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:03:36
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_Lut2D_SF_FLT
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 0)) {
        ...
        if ((int_T)mxGetNumberOfDimensions(ssGetSFcnParam(S, 0)) < 2) {
            ssSetErrorStatus(S,"Parameter 1 must have 2 dimensions");
            return;
        } /* if */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_Lut2D_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
