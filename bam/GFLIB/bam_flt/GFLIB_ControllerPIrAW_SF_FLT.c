/**
 * GFLIB_ControllerPIrAW_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = GFLIB_ControllerPIrAW_w_FLT(single u1, GFLIB_CONTROLLER_PIAW_R_T_FLT work1[1], int32 work2[1], single u2, single u3, single u4, single u5, single u6, single u7, single u8, single y2[1], single y3[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:02:20
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_ControllerPIrAW_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_ControllerPIrAWInit_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GFLIB_ControllerPIrAW_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIrAWInit_w_FLT_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GFLIB_ControllerPIrAW_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIrAW_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GFLIB_ControllerPIrAW_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PIAW_R_T_FLT* __work1BUS = (GFLIB_CONTROLLER_PIAW_R_T_FLT*) ssGetPWorkValue(S, 0);
        ...
        (void) memcpy(&__work1BUS[0].fltUpperLimit, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].fltLowerLimit, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);

        /* Call the legacy code function */
        GFLIB_ControllerPIrAWInit_w_FLT(*p3, *p4, *p5, *p6, __work1BUS, work2, *p2);
        ...
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].fltUpperLimit,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].fltLowerLimit,  __dtBusInfo[11]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GFLIB_ControllerPIrAW_w_FLT(*u1, __work1BUS, work2, *u2, *u3, *u4, *u5, *u6, *u7, *u8, y2, y3, *p1, *p2);
