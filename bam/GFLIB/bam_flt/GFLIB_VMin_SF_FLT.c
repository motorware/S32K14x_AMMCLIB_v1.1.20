 ...
 *
 *         uint32 y1 = GFLIB_VMin_w_FLT(single u1[])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:04:42
 *
 */
...
#define S_FUNCTION_NAME  GFLIB_VMin_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GFLIB_VMin_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = GFLIB_VMin_w_FLT(u1, ssGetCurrentInputPortWidth(S, 0));
}
