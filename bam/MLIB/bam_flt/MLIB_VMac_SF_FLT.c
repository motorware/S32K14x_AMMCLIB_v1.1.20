 ...
 *
 *         single y1 = MLIB_VMac_w_FLT(single u1, single u2, single u3, single u4)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:09:42
 *
 */
...
#define S_FUNCTION_NAME  MLIB_VMac_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MLIB_VMac_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = MLIB_VMac_w_FLT(*u1, *u2, *u3, *u4);
}
