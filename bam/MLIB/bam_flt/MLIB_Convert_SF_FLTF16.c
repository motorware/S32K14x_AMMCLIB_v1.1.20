/**
 * MLIB_Convert_SF_FLTF16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = MLIB_Convert_w_FLTF16(int16 u1, int16 u2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:07:22
 *
 */
...
#define S_FUNCTION_NAME  MLIB_Convert_SF_FLTF16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MLIB_Convert_w_FLTF16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = MLIB_Convert_w_FLTF16(*u1, *u2);
}
