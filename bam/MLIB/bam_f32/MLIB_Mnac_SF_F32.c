 ...
 *
 *         int32 y1 = MLIB_Mnac_w_F32(int32 u1, int32 u2, int32 u3)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:07:55
 *
 */
...
#define S_FUNCTION_NAME  MLIB_Mnac_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MLIB_Mnac_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
