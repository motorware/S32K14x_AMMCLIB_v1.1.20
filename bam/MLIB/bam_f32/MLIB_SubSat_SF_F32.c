/**
 * MLIB_SubSat_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32 y1 = MLIB_SubSat_w_F32(int32 u1, int32 u2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:09:25
 *
 */
...
#define S_FUNCTION_NAME  MLIB_SubSat_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MLIB_SubSat_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
