/**
 * GDFLIB_FilterIIR2_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = GDFLIB_FilterIIR2_w_FLT(single u1, single u2, single u3, single u4, single u5, single u6, single u7, single u8, single u9, single u10, GDFLIB_FILTER_IIR2_T_FLT work1[1], single y2[1], single y3[1], single y4[1], single y5[1], int32 p1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:00:41
 *
 */
...
#define S_FUNCTION_NAME  GDFLIB_FilterIIR2_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GDFLIB_FILTER_IIR2_T_FLT", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GDFLIB_FilterIIR2Init_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GDFLIB_FilterIIR2_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2Init_w_FLT_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GDFLIB_FILTER_IIR2_T_FLTId = ssGetDataTypeId(S, "GDFLIB_FILTER_IIR2_T_FLT");
        DTypeId __GDFLIB_FILTER_IIR2_COEFF_T_FLTId = ssGetDataTypeId(S, "GDFLIB_FILTER_IIR2_COEFF_T_FLT");
        DTypeId __singleId = ssGetDataTypeId(S, "single");

        /* Get common data type size */
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __GDFLIB_FILTER_IIR2_T_FLTId);
        __dtSizeInfo[1] = ssGetDataTypeSize(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId);
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __singleId);

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.trFiltCoeff.fltB0 */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId, 0);
        __dtBusInfo[1] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.trFiltCoeff.fltB1 */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId, 1);
        __dtBusInfo[3] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.trFiltCoeff.fltB2 */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId, 2);
        __dtBusInfo[5] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.trFiltCoeff.fltA1 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId, 3);
        __dtBusInfo[7] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.trFiltCoeff.fltA2 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_FLTId, 4);
        __dtBusInfo[9] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.fltFiltBufferX */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 1);
        __dtBusInfo[11] = 2*__dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_FLT.fltFiltBufferY */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_FLTId, 2);
        __dtBusInfo[13] = 2*__dtSizeInfo[2];


        /* Alloc memory for the pwork 1 (__work1BUS) */
        {
            GDFLIB_FILTER_IIR2_T_FLT* __work1BUS = (GDFLIB_FILTER_IIR2_T_FLT*)calloc(sizeof(GDFLIB_FILTER_IIR2_T_FLT), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GDFLIB_FILTER_IIR2_T_FLT* __work1BUS = (GDFLIB_FILTER_IIR2_T_FLT*) ssGetPWorkValue(S, 0);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].trFiltCoeff.fltB0, work1 +  __dtBusInfo[0],  __dtBusInfo[1]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.fltB1, work1 +  __dtBusInfo[2],  __dtBusInfo[3]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.fltB2, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.fltA1, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.fltA2, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(__work1BUS[0].fltFiltBufferX, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(__work1BUS[0].fltFiltBufferY, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);

        /* Call the legacy code function */
        GDFLIB_FilterIIR2Init_w_FLT(*p2, *p3, *p4, *p5, *p6, __work1BUS);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[0], &__work1BUS[0].trFiltCoeff.fltB0,  __dtBusInfo[1]);
        (void) memcpy(work1 +  __dtBusInfo[2], &__work1BUS[0].trFiltCoeff.fltB1,  __dtBusInfo[3]);
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].trFiltCoeff.fltB2,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].trFiltCoeff.fltA1,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].trFiltCoeff.fltA2,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], __work1BUS[0].fltFiltBufferX,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], __work1BUS[0].fltFiltBufferY,  __dtBusInfo[13]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GDFLIB_FilterIIR2_w_FLT(*u1, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, __work1BUS, y2, y3, y4, y5, *p1);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GDFLIB_FILTER_IIR2_T_FLT', specification */
    {
        uint32_T chk[] = {3929567424, 2959847318, 1248758402, 475745675};
        int_T status;
        status = CheckDataTypeChecksum(S, "GDFLIB_FILTER_IIR2_T_FLT", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_T_FLT'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_T_FLT' definition has changed since the S-Function was generated");
        }
    }

    /* Verify Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_FLT', specification */
    {
        uint32_T chk[] = {226211571, 2802634932, 3216380632, 220644016};
        int_T status;
        status = CheckDataTypeChecksum(S, "GDFLIB_FILTER_IIR2_COEFF_T_FLT", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_FLT'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_FLT' definition has changed since the S-Function was generated");
        }
    }
}
