/**
 * GDFLIB_FilterIIR2_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16 y1 = GDFLIB_FilterIIR2_w_F16(int16 u1, int16 u2, int16 u3, int32 u4, int32 u5, int16 u6, int16 u7, int16 u8, int16 u9, int16 u10, GDFLIB_FILTER_IIR2_T_F16 work1[1], int16 y2[1], int16 y3[1], int32 y4[1], int32 y5[1], int32 p1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:00:39
 *
 */
...
#define S_FUNCTION_NAME  GDFLIB_FilterIIR2_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GDFLIB_FILTER_IIR2_T_F16", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GDFLIB_FilterIIR2Init_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GDFLIB_FilterIIR2_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2Init_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GDFLIB_FilterIIR2_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GDFLIB_FILTER_IIR2_T_F16Id = ssGetDataTypeId(S, "GDFLIB_FILTER_IIR2_T_F16");
        DTypeId __GDFLIB_FILTER_IIR2_COEFF_T_F16Id = ssGetDataTypeId(S, "GDFLIB_FILTER_IIR2_COEFF_T_F16");
        DTypeId __int16Id = ssGetDataTypeId(S, "int16");
        DTypeId __int32Id = ssGetDataTypeId(S, "int32");

        /* Get common data type size */
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __GDFLIB_FILTER_IIR2_T_F16Id);
        __dtSizeInfo[1] = ssGetDataTypeSize(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id);
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __int16Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __int32Id);

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.trFiltCoeff.f16B0 */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id, 0);
        __dtBusInfo[1] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.trFiltCoeff.f16B1 */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id, 1);
        __dtBusInfo[3] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.trFiltCoeff.f16B2 */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id, 2);
        __dtBusInfo[5] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.trFiltCoeff.f16A1 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id, 3);
        __dtBusInfo[7] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.trFiltCoeff.f16A2 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 0) + ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_COEFF_T_F16Id, 4);
        __dtBusInfo[9] = __dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.f16FiltBufferX */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 1);
        __dtBusInfo[11] = 2*__dtSizeInfo[2];

        /* Get information for accessing GDFLIB_FILTER_IIR2_T_F16.f32FiltBufferY */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __GDFLIB_FILTER_IIR2_T_F16Id, 2);
        __dtBusInfo[13] = 2*__dtSizeInfo[3];


        /* Alloc memory for the pwork 1 (__work1BUS) */
        {
            GDFLIB_FILTER_IIR2_T_F16* __work1BUS = (GDFLIB_FILTER_IIR2_T_F16*)calloc(sizeof(GDFLIB_FILTER_IIR2_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GDFLIB_FILTER_IIR2_T_F16* __work1BUS = (GDFLIB_FILTER_IIR2_T_F16*) ssGetPWorkValue(S, 0);
        ...
        (void) memcpy(&__work1BUS[0].trFiltCoeff.f16B2, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.f16A1, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].trFiltCoeff.f16A2, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(__work1BUS[0].f16FiltBufferX, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(__work1BUS[0].f32FiltBufferY, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);

        /* Call the legacy code function */
        GDFLIB_FilterIIR2Init_w_F16(*p2, *p3, *p4, *p5, *p6, __work1BUS);
        ...
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].trFiltCoeff.f16B2,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].trFiltCoeff.f16A1,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].trFiltCoeff.f16A2,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], __work1BUS[0].f16FiltBufferX,  __dtBusInfo[11]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        *y1 = GDFLIB_FilterIIR2_w_F16(*u1, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, __work1BUS, y2, y3, y4, y5, *p1);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GDFLIB_FILTER_IIR2_T_F16', specification */
    {
        uint32_T chk[] = {1773687394, 2769427677, 2123586202, 4055358406};
        int_T status;
        status = CheckDataTypeChecksum(S, "GDFLIB_FILTER_IIR2_T_F16", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_T_F16'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_T_F16' definition has changed since the S-Function was generated");
        }
    }

    /* Verify Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_F16', specification */
    {
        uint32_T chk[] = {2626860394, 280009025, 4157602955, 87056177};
        int_T status;
        status = CheckDataTypeChecksum(S, "GDFLIB_FILTER_IIR2_COEFF_T_F16", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_F16'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GDFLIB_FILTER_IIR2_COEFF_T_F16' definition has changed since the S-Function was generated");
        }
    }
}
