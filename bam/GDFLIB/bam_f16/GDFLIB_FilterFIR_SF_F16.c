/**
 * GDFLIB_FilterFIR_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16 y1 = GDFLIB_FilterFIR_w_F16(int16 u1, uint16 p1, int16 p2[], uint16 work1[1], int16 work2[p1+2])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:00:19
 *
 */
...
#define S_FUNCTION_NAME  GDFLIB_FilterFIR_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetDWorkWidth(S, 1, (int_T)mxGetScalar(ssGetSFcnParam(S, 0))+2);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GDFLIB_FilterFIRInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GDFLIB_FilterFIR_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlInitializeConditions(SimStruct *S)
{
    ...
    GDFLIB_FilterFIRInit_w_F16(*p1, work1, work2);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    *y1 = GDFLIB_FilterFIR_w_F16(*u1, *p1, p2, work1, work2);
}
