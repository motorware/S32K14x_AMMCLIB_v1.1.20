/**
 * GMCLIB_BetaProjection3Ph_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_BetaProjection3Ph_w_FLT(SWLIBS_3Syst_FLT y1[1], SWLIBS_3Syst_FLT u1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:04:59
 *
 */
...
#define S_FUNCTION_NAME  GMCLIB_BetaProjection3Ph_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    #endif
    ssSetBusOutputObjectName(S, 0, (void *)"SWLIBS_3Syst_FLT");
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_BetaProjection3Ph_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_BetaProjection3Ph_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_BetaProjection3Ph_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_BetaProjection3Ph_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        {
            SWLIBS_3Syst_FLT* __y1BUS = (SWLIBS_3Syst_FLT*)calloc(sizeof(SWLIBS_3Syst_FLT), ssGetOutputPortWidth(S, 0));
            if (__y1BUS==NULL) {
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_3Syst_FLT* __y1BUS = (SWLIBS_3Syst_FLT*) ssGetPWorkValue(S, 0);
        SWLIBS_3Syst_FLT* __u1BUS = (SWLIBS_3Syst_FLT*) ssGetPWorkValue(S, 1);
        ...
        GMCLIB_BetaProjection3Ph_w_FLT(__y1BUS, __u1BUS);
