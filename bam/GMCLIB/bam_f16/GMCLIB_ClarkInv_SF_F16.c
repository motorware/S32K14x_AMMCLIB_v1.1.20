/**
 * GMCLIB_ClarkInv_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_ClarkInv_w_F16(SWLIBS_3Syst_F16 y1[1], SWLIBS_2Syst_F16 u1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:05:13
 *
 */
...
#define S_FUNCTION_NAME  GMCLIB_ClarkInv_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    #endif
    ssSetBusOutputObjectName(S, 0, (void *)"SWLIBS_3Syst_F16");
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_ClarkInv_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_ClarkInv_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_ClarkInv_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_ClarkInv_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        {
            SWLIBS_3Syst_F16* __y1BUS = (SWLIBS_3Syst_F16*)calloc(sizeof(SWLIBS_3Syst_F16), ssGetOutputPortWidth(S, 0));
            if (__y1BUS==NULL) {
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_3Syst_F16* __y1BUS = (SWLIBS_3Syst_F16*) ssGetPWorkValue(S, 0);
        ...
        GMCLIB_ClarkInv_w_F16(__y1BUS, __u1BUS);
        ...
        (void) memcpy(y1 +  __dtBusInfo[4], &__y1BUS[0].f16Arg3,  __dtBusInfo[5]);
    } /* if */
}
