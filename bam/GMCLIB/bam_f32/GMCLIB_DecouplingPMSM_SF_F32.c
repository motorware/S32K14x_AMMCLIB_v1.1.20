/**
 * GMCLIB_DecouplingPMSM_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_DecouplingPMSM_w_F32(SWLIBS_2Syst_F32 u1[1], SWLIBS_2Syst_F32 u2[1], int32 u3, int32 u4, int16 u5, int32 u6, int16 u7, int32 p1, GMCLIB_DECOUPLINGPMSM_T_F32 work1[1], SWLIBS_2Syst_F32 y1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:05:27
 *
 */
...
#define S_FUNCTION_NAME  GMCLIB_DecouplingPMSM_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GMCLIB_DECOUPLINGPMSM_T_F32", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_DecouplingPMSMInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GMCLIB_DecouplingPMSM_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_DecouplingPMSMInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_DecouplingPMSM_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_DecouplingPMSM_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_DecouplingPMSM_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GMCLIB_DECOUPLINGPMSM_T_F32Id = ssGetDataTypeId(S, "GMCLIB_DECOUPLINGPMSM_T_F32");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __GMCLIB_DECOUPLINGPMSM_T_F32Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __int16Id);
        ...
        /* Get information for accessing GMCLIB_DECOUPLINGPMSM_T_F32.f32Kd */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GMCLIB_DECOUPLINGPMSM_T_F32Id, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_DECOUPLINGPMSM_T_F32.s16KdShift */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GMCLIB_DECOUPLINGPMSM_T_F32Id, 1);
        __dtBusInfo[7] = __dtSizeInfo[3];

        /* Get information for accessing GMCLIB_DECOUPLINGPMSM_T_F32.f32Kq */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GMCLIB_DECOUPLINGPMSM_T_F32Id, 2);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_DECOUPLINGPMSM_T_F32.s16KqShift */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __GMCLIB_DECOUPLINGPMSM_T_F32Id, 3);
        ...
        {
            GMCLIB_DECOUPLINGPMSM_T_F32* __work1BUS = (GMCLIB_DECOUPLINGPMSM_T_F32*)calloc(sizeof(GMCLIB_DECOUPLINGPMSM_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GMCLIB_DECOUPLINGPMSM_T_F32* __work1BUS = (GMCLIB_DECOUPLINGPMSM_T_F32*) ssGetPWorkValue(S, 3);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f32Kd, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].s16KdShift, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].f32Kq, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].s16KqShift, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);

        /* Call the legacy code function */
        GMCLIB_DecouplingPMSMInit_w_F32(*p2, *p3, *p4, *p5, __work1BUS);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f32Kd,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].s16KdShift,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].f32Kq,  __dtBusInfo[9]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_F32* __u2BUS = (SWLIBS_2Syst_F32*) ssGetPWorkValue(S, 2);
        GMCLIB_DECOUPLINGPMSM_T_F32* __work1BUS = (GMCLIB_DECOUPLINGPMSM_T_F32*) ssGetPWorkValue(S, 3);
        ...
        /* Call the legacy code function */
        GMCLIB_DecouplingPMSM_w_F32(__u1BUS, __u2BUS, *u3, *u4, *u5, *u6, *u7, *p1, __work1BUS, __y1BUS);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GMCLIB_DECOUPLINGPMSM_T_F32', specification */
    {
        uint32_T chk[] = {3206345991, 2962042736, 1491733440, 3976977712};
        int_T status;
        status = CheckDataTypeChecksum(S, "GMCLIB_DECOUPLINGPMSM_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GMCLIB_DECOUPLINGPMSM_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GMCLIB_DECOUPLINGPMSM_T_F32' definition has changed since the S-Function was generated");
        }
    }
}
