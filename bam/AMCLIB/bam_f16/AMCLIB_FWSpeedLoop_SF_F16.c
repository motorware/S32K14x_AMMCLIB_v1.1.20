/**
 * AMCLIB_FWSpeedLoop_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_FWSpeedLoop_w_F16(int16 u1, int16 u2, SWLIBS_2Syst_F16 work1[1], GDFLIB_FILTER_MA_T_F16 work2[1], GDFLIB_FILTER_MA_T_F16 work3[1], GFLIB_CONTROLLER_PIAW_P_T_F16 work4[1], GFLIB_CONTROLLER_PIAW_P_T_F16 work5[1], GFLIB_RAMP_T_F32 work6[1], int16 work7[1], int16 u3[1], int16 u4[1], int16 u5[1], int16 u6, int16 u7, int16 u8, int16 u9, int32 u10, uint16 u11, uint16 u12, int16 u13, int16 u14, int16 u15, int16 u16, int16 u17, int16 u18, int16 u19, int16 u20, int16 u21, int16 u22, int16 u23, int16 u24, int32 u25, int32 u26, int16 u27, int32 u28, int32 u29, int32 u30, int16 u31, int32 u32, int16 u33, int32 u34, SWLIBS_2Syst_F16 y1[1], uint16 y2[1], uint16 y3[1], int16 y4[1], int16 y5[1], int16 y6[1], int16 y7[1], int16 y8[1], int16 y9[1], int16 y10[1], int16 y11[1], int16 y12[1], int16 y13[1], int16 y14[1], int16 y15[1], int32 y16[1], int32 y17[1], int32 y18[1], int16 y19[1], int32 y20[1], int16 y21[1], int32 y22[1], int32 p1, int32 p2, int32 p3)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:57:46
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_FWSpeedLoop_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetDWorkDataType(S, 6, SS_INT16);
    ...
    ssSetInputPortDataType(S, 18, SS_INT16);
    {
        int_T u19Width = 1;
    ...
    ssSetInputPortDataType(S, 22, SS_INT16);
    {
        int_T u23Width = 1;
    ...
    ssSetInputPortDataType(S, 26, SS_INT16);
    {
        int_T u27Width = 1;
    ...
    ssSetInputPortDataType(S, 30, SS_INT16);
    {
        int_T u31Width = 1;
    ...
    ssSetInputPortDataType(S, 32, SS_INT16);
    {
        int_T u33Width = 1;
    ...
    ssSetOutputPortDataType(S, 13, SS_INT16);
    {
        int_T y14Width = 1;
    ...
    ssSetOutputPortDataType(S, 14, SS_INT16);
    {
        int_T y15Width = 1;
    ...
    ssSetOutputPortDataType(S, 18, SS_INT16);
    {
        int_T y19Width = 1;
    ...
    ssSetOutputPortDataType(S, 20, SS_INT16);
    {
        int_T y21Width = 1;
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_FWSpeedLoopInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_FWSpeedLoop_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FWSpeedLoopInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FWSpeedLoop_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FWSpeedLoop_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FWSpeedLoop_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 15, 15, "p16", ssGetDataTypeId(S, "int16"));

    /* Register the run-time parameter 17 */
    ssRegDlgParamAsRunTimeParam(S, 16, 16, "p17", ssGetDataTypeId(S, "int16"));
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        {
            GDFLIB_FILTER_MA_T_F16* __work3BUS = (GDFLIB_FILTER_MA_T_F16*)calloc(sizeof(GDFLIB_FILTER_MA_T_F16), ssGetDWorkWidth(S, 2));
            if (__work3BUS==NULL) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_P_T_F16* __work4BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_P_T_F16), ssGetDWorkWidth(S, 3));
            if (__work4BUS==NULL) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_P_T_F16* __work5BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_P_T_F16), ssGetDWorkWidth(S, 4));
            if (__work5BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int16_T* work7 = (int16_T*) ssGetDWork(S, 6);
        ...
        int16_T* p16 = (int16_T*) ssGetRunTimeParamInfo(S, 15)->data;
        int16_T* p17 = (int16_T*) ssGetRunTimeParamInfo(S, 16)->data;
        ...
        GDFLIB_FILTER_MA_T_F16* __work3BUS = (GDFLIB_FILTER_MA_T_F16*) ssGetPWorkValue(S, 3);
        GFLIB_CONTROLLER_PIAW_P_T_F16* __work4BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*) ssGetPWorkValue(S, 4);
        GFLIB_CONTROLLER_PIAW_P_T_F16* __work5BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*) ssGetPWorkValue(S, 5);
        ...
        (void) memcpy(&__work4BUS[0].f16PropGain, work4 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work4BUS[0].f16IntegGain, work4 +  __dtBusInfo[10],  __dtBusInfo[11]);
        ...
        (void) memcpy(&__work4BUS[0].f16LowerLimit, work4 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work4BUS[0].f16UpperLimit, work4 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work4BUS[0].f32IntegPartK_1, work4 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work4BUS[0].f16InK_1, work4 +  __dtBusInfo[22],  __dtBusInfo[23]);
        ...
        (void) memcpy(&__work5BUS[0].f16PropGain, work5 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work5BUS[0].f16IntegGain, work5 +  __dtBusInfo[10],  __dtBusInfo[11]);
        ...
        (void) memcpy(&__work5BUS[0].f16LowerLimit, work5 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work5BUS[0].f16UpperLimit, work5 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work5BUS[0].f32IntegPartK_1, work5 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work5BUS[0].f16InK_1, work5 +  __dtBusInfo[22],  __dtBusInfo[23]);
        ...
        AMCLIB_FWSpeedLoopInit_w_F16(__work1BUS, __work2BUS, __work3BUS, __work4BUS, __work5BUS, __work6BUS, work7, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p1, *p2, *p3);
        ...
        (void) memcpy(work4 +  __dtBusInfo[8], &__work4BUS[0].f16PropGain,  __dtBusInfo[9]);
        (void) memcpy(work4 +  __dtBusInfo[10], &__work4BUS[0].f16IntegGain,  __dtBusInfo[11]);
        ...
        (void) memcpy(work4 +  __dtBusInfo[16], &__work4BUS[0].f16LowerLimit,  __dtBusInfo[17]);
        (void) memcpy(work4 +  __dtBusInfo[18], &__work4BUS[0].f16UpperLimit,  __dtBusInfo[19]);
        (void) memcpy(work4 +  __dtBusInfo[20], &__work4BUS[0].f32IntegPartK_1,  __dtBusInfo[21]);
        (void) memcpy(work4 +  __dtBusInfo[22], &__work4BUS[0].f16InK_1,  __dtBusInfo[23]);
        ...
        (void) memcpy(work5 +  __dtBusInfo[8], &__work5BUS[0].f16PropGain,  __dtBusInfo[9]);
        (void) memcpy(work5 +  __dtBusInfo[10], &__work5BUS[0].f16IntegGain,  __dtBusInfo[11]);
        ...
        (void) memcpy(work5 +  __dtBusInfo[16], &__work5BUS[0].f16LowerLimit,  __dtBusInfo[17]);
        (void) memcpy(work5 +  __dtBusInfo[18], &__work5BUS[0].f16UpperLimit,  __dtBusInfo[19]);
        (void) memcpy(work5 +  __dtBusInfo[20], &__work5BUS[0].f32IntegPartK_1,  __dtBusInfo[21]);
        (void) memcpy(work5 +  __dtBusInfo[22], &__work5BUS[0].f16InK_1,  __dtBusInfo[23]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int16_T* u19 = (int16_T*) ssGetInputPortSignal(S, 18);
        ...
        int16_T* u23 = (int16_T*) ssGetInputPortSignal(S, 22);
        ...
        int16_T* u27 = (int16_T*) ssGetInputPortSignal(S, 26);
        ...
        int16_T* u31 = (int16_T*) ssGetInputPortSignal(S, 30);
        int32_T* u32 = (int32_T*) ssGetInputPortSignal(S, 31);
        int16_T* u33 = (int16_T*) ssGetInputPortSignal(S, 32);
        ...
        int16_T* y12 = (int16_T*) ssGetOutputPortSignal(S, 11);
        int16_T* y13 = (int16_T*) ssGetOutputPortSignal(S, 12);
        int16_T* y14 = (int16_T*) ssGetOutputPortSignal(S, 13);
        int16_T* y15 = (int16_T*) ssGetOutputPortSignal(S, 14);
        ...
        int16_T* y19 = (int16_T*) ssGetOutputPortSignal(S, 18);
        int32_T* y20 = (int32_T*) ssGetOutputPortSignal(S, 19);
        int16_T* y21 = (int16_T*) ssGetOutputPortSignal(S, 20);
