/**
 * AMCLIB_CurrentLoop_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_CurrentLoop_w_F16(int16 u1, GFLIB_CONTROLLER_PIAW_R_T_F16 work1[1], GFLIB_CONTROLLER_PIAW_R_T_F16 work2[1], SWLIBS_2Syst_F16 u2[1], SWLIBS_2Syst_F16 u3[1], int16 work3[1], int16 u4, int16 u5, int16 u6, int16 u7, uint16 u8, int16 u9, int16 u10, uint16 u11, int32 u12, int16 u13, int32 u14, int16 u15, SWLIBS_2Syst_F16 y1[1], int32 y2[1], int16 y3[1], int32 y4[1], int16 y5[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:57:06
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_CurrentLoop_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GFLIB_CONTROLLER_PIAW_R_T_F16", &dataTypeIdReg);
    ...
    ssSetDWorkDataType(S, 2, SS_INT16);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_CurrentLoopInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_CurrentLoop_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 7, 7, "p8", ssGetDataTypeId(S, "uint16"));
}
#endif
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id);
        ...
        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f16CC1sc */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f16CC2sc */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 1);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f32Acc */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 2);
        __dtBusInfo[9] = __dtSizeInfo[3];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f16InErrK1 */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 3);
        __dtBusInfo[11] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f16UpperLimit */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 4);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.f16LowerLimit */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 5);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing GFLIB_CONTROLLER_PIAW_R_T_F16.u16NShift */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 6);
        ...
        {
            SWLIBS_2Syst_F16* __u3BUS = (SWLIBS_2Syst_F16*)calloc(sizeof(SWLIBS_2Syst_F16), ssGetInputPortWidth(S, 2));
            if (__u3BUS==NULL) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_R_T_F16* __work1BUS = (GFLIB_CONTROLLER_PIAW_R_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_R_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_R_T_F16* __work2BUS = (GFLIB_CONTROLLER_PIAW_R_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_R_T_F16), ssGetDWorkWidth(S, 1));
            if (__work2BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int16_T* work3 = (int16_T*) ssGetDWork(S, 2);
        ...
        uint16_T* p8 = (uint16_T*) ssGetRunTimeParamInfo(S, 7)->data;
        int32_T* p2 = (int32_T*) ssGetRunTimeParamInfo(S, 1)->data;

        GFLIB_CONTROLLER_PIAW_R_T_F16* __work1BUS = (GFLIB_CONTROLLER_PIAW_R_T_F16*) ssGetPWorkValue(S, 3);
        GFLIB_CONTROLLER_PIAW_R_T_F16* __work2BUS = (GFLIB_CONTROLLER_PIAW_R_T_F16*) ssGetPWorkValue(S, 4);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f16CC1sc, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].f16CC2sc, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].f32Acc, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].f16InErrK1, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work1BUS[0].f16UpperLimit, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].f16LowerLimit, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].u16NShift, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);

        /* Assign the Simulink structure work2 to user structure __work2BUS */
        (void) memcpy(&__work2BUS[0].f16CC1sc, work2 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work2BUS[0].f16CC2sc, work2 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work2BUS[0].f32Acc, work2 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work2BUS[0].f16InErrK1, work2 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work2BUS[0].f16UpperLimit, work2 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work2BUS[0].f16LowerLimit, work2 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work2BUS[0].u16NShift, work2 +  __dtBusInfo[16],  __dtBusInfo[17]);

        /* Call the legacy code function */
        AMCLIB_CurrentLoopInit_w_F16(__work1BUS, __work2BUS, work3, *p3, *p4, *p5, *p6, *p7, *p8, *p2);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f16CC1sc,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f16CC2sc,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].f32Acc,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].f16InErrK1,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].f16UpperLimit,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].f16LowerLimit,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].u16NShift,  __dtBusInfo[17]);

        /* Assign the user structure __work2BUS to the Simulink structure work2 */
        (void) memcpy(work2 +  __dtBusInfo[4], &__work2BUS[0].f16CC1sc,  __dtBusInfo[5]);
        (void) memcpy(work2 +  __dtBusInfo[6], &__work2BUS[0].f16CC2sc,  __dtBusInfo[7]);
        (void) memcpy(work2 +  __dtBusInfo[8], &__work2BUS[0].f32Acc,  __dtBusInfo[9]);
        (void) memcpy(work2 +  __dtBusInfo[10], &__work2BUS[0].f16InErrK1,  __dtBusInfo[11]);
        (void) memcpy(work2 +  __dtBusInfo[12], &__work2BUS[0].f16UpperLimit,  __dtBusInfo[13]);
        (void) memcpy(work2 +  __dtBusInfo[14], &__work2BUS[0].f16LowerLimit,  __dtBusInfo[15]);
        (void) memcpy(work2 +  __dtBusInfo[16], &__work2BUS[0].u16NShift,  __dtBusInfo[17]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_F16* __u3BUS = (SWLIBS_2Syst_F16*) ssGetPWorkValue(S, 2);
        ...
        (void) memcpy(&__u3BUS[0].f16Arg1, u3 +  __dtBusInfo[0],  __dtBusInfo[1]);
        (void) memcpy(&__u3BUS[0].f16Arg2, u3 +  __dtBusInfo[2],  __dtBusInfo[3]);

        /* Call the legacy code function */
        AMCLIB_CurrentLoop_w_F16(*u1, __work1BUS, __work2BUS, __u2BUS, __u3BUS, work3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, __y1BUS, y2, y3, y4, y5, *p1, *p2);
