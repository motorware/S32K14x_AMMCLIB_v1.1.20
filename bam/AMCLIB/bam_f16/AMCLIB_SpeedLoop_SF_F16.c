/**
 * AMCLIB_SpeedLoop_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_SpeedLoop_w_F16(int16 u1, int16 u2, GDFLIB_FILTER_MA_T_F16 work1[1], GFLIB_CONTROLLER_PIAW_P_T_F16 work2[1], GFLIB_RAMP_T_F32 work3[1], int16 work4[1], int16 u3, int16 u4, int32 u5, uint16 u6, int16 u7, int16 u8, int16 u9, int16 u10, int16 u11, int16 u12, int32 u13, int32 u14, int32 u15, int32 u16, int16 u17, int32 u18, SWLIBS_2Syst_F16 y1[1], uint16 y2[1], int16 y3[1], int16 y4[1], int16 y5[1], int32 y6[1], int32 y7[1], int16 y8[1], int32 y9[1], int32 p1, int32 p2, int32 p3)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:59:24
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_SpeedLoop_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_SpeedLoopInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_SpeedLoop_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_SpeedLoopInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_SpeedLoop_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_SpeedLoop_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_SpeedLoop_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 12)) return;
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        {
            GDFLIB_FILTER_MA_T_F16* __work1BUS = (GDFLIB_FILTER_MA_T_F16*)calloc(sizeof(GDFLIB_FILTER_MA_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_P_T_F16* __work2BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_P_T_F16), ssGetDWorkWidth(S, 1));
            if (__work2BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GDFLIB_FILTER_MA_T_F16* __work1BUS = (GDFLIB_FILTER_MA_T_F16*) ssGetPWorkValue(S, 1);
        GFLIB_CONTROLLER_PIAW_P_T_F16* __work2BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*) ssGetPWorkValue(S, 2);
        ...
        (void) memcpy(&__work2BUS[0].f16PropGain, work2 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work2BUS[0].f16IntegGain, work2 +  __dtBusInfo[10],  __dtBusInfo[11]);
        ...
        (void) memcpy(&__work2BUS[0].f16LowerLimit, work2 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work2BUS[0].f16UpperLimit, work2 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work2BUS[0].f32IntegPartK_1, work2 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work2BUS[0].f16InK_1, work2 +  __dtBusInfo[22],  __dtBusInfo[23]);
        ...
        AMCLIB_SpeedLoopInit_w_F16(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p1, *p2, *p3);
        ...
        (void) memcpy(work2 +  __dtBusInfo[8], &__work2BUS[0].f16PropGain,  __dtBusInfo[9]);
        (void) memcpy(work2 +  __dtBusInfo[10], &__work2BUS[0].f16IntegGain,  __dtBusInfo[11]);
        ...
        (void) memcpy(work2 +  __dtBusInfo[16], &__work2BUS[0].f16LowerLimit,  __dtBusInfo[17]);
        (void) memcpy(work2 +  __dtBusInfo[18], &__work2BUS[0].f16UpperLimit,  __dtBusInfo[19]);
        (void) memcpy(work2 +  __dtBusInfo[20], &__work2BUS[0].f32IntegPartK_1,  __dtBusInfo[21]);
        (void) memcpy(work2 +  __dtBusInfo[22], &__work2BUS[0].f16InK_1,  __dtBusInfo[23]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_SpeedLoop_w_F16(*u1, *u2, __work1BUS, __work2BUS, __work3BUS, work4, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, *u17, *u18, __y1BUS, y2, y3, y4, y5, y6, y7, y8, y9, *p1, *p2, *p3);
