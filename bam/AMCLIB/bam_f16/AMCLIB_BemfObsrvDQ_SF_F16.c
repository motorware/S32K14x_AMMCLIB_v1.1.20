/**
 * AMCLIB_BemfObsrvDQ_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16 y1 = AMCLIB_BemfObsrvDQ_w_F16(SWLIBS_2Syst_F16 u1[1], SWLIBS_2Syst_F16 u2[1], int16 u3, int16 u4, AMCLIB_BEMF_OBSRV_DQ_T_F16 work1[1], int16 work2[1], int16 u5, int16 u6, int16 u7, int16 u8, int16 u9, int16 u10, int16 u11, int16 u12, int16 u13, int16 u14, int16 u15, int16 u16, int16 u17, uint16 u18, int32 u19, int16 u20, int32 u21, int16 u22, int32 u23, int16 u24, int32 u25, int16 u26, int32 u27, int32 u28, int16 y2[1], int16 y3[1], int32 y4[1], int16 y5[1], int32 y6[1], int16 y7[1], int32 y8[1], int16 y9[1], int32 y10[1], int16 y11[1], int32 y12[1], int32 y13[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:56:41
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_BemfObsrvDQ_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_BEMF_OBSRV_DQ_T_F16", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQ_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQ_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQ_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_BemfObsrvDQ_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 11, 11, "p12", ssGetDataTypeId(S, "int16"));

    /* Register the run-time parameter 13 */
    ssRegDlgParamAsRunTimeParam(S, 12, 12, "p13", ssGetDataTypeId(S, "int16"));
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __AMCLIB_BEMF_OBSRV_DQ_T_F16Id = ssGetDataTypeId(S, "AMCLIB_BEMF_OBSRV_DQ_T_F16");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __SWLIBS_2Syst_F32Id);
        __dtSizeInfo[4] = ssGetDataTypeSize(S, __int32Id);
        __dtSizeInfo[5] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id);
        ...
        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pEObsrv.f16Arg1 */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 0) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F16Id, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pEObsrv.f16Arg2 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 0) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F16Id, 1);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrv.f32Arg1 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 1) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 0);
        __dtBusInfo[9] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrv.f32Arg2 */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 1) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 1);
        __dtBusInfo[11] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f16CC1sc */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 0);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f16CC2sc */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 1);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f32Acc */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 2);
        __dtBusInfo[17] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f16InErrK1 */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 3);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f16UpperLimit */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 4);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.f16LowerLimit */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 5);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamD.u16NShift */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 2) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 6);
        __dtBusInfo[25] = __dtSizeInfo[6];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f16CC1sc */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 0);
        __dtBusInfo[27] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f16CC2sc */
        __dtBusInfo[28] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 1);
        __dtBusInfo[29] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f32Acc */
        __dtBusInfo[30] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 2);
        __dtBusInfo[31] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f16InErrK1 */
        __dtBusInfo[32] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 3);
        __dtBusInfo[33] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f16UpperLimit */
        __dtBusInfo[34] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 4);
        __dtBusInfo[35] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.f16LowerLimit */
        __dtBusInfo[36] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 5);
        __dtBusInfo[37] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pParamQ.u16NShift */
        __dtBusInfo[38] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 3) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F16Id, 6);
        __dtBusInfo[39] = __dtSizeInfo[6];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrvIn_1L.f32Arg1 */
        __dtBusInfo[40] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 4) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 0);
        __dtBusInfo[41] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrvIn_1L.f32Arg2 */
        __dtBusInfo[42] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 4) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 1);
        __dtBusInfo[43] = __dtSizeInfo[4];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrvIn_1H.f16Arg1 */
        __dtBusInfo[44] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 5) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F16Id, 0);
        __dtBusInfo[45] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.pIObsrvIn_1H.f16Arg2 */
        __dtBusInfo[46] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 5) + ssGetBusElementOffset(S, __SWLIBS_2Syst_F16Id, 1);
        __dtBusInfo[47] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.f16IGain */
        __dtBusInfo[48] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 6);
        __dtBusInfo[49] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.f16UGain */
        __dtBusInfo[50] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 7);
        __dtBusInfo[51] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.f16WIGain */
        __dtBusInfo[52] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 8);
        __dtBusInfo[53] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.f16EGain */
        __dtBusInfo[54] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 9);
        __dtBusInfo[55] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_BEMF_OBSRV_DQ_T_F16.s16Shift */
        __dtBusInfo[56] = ssGetBusElementOffset(S, __AMCLIB_BEMF_OBSRV_DQ_T_F16Id, 10);
        __dtBusInfo[57] = __dtSizeInfo[1];


        /* Alloc memory for the pwork 1 (__u1BUS) */
        {
            SWLIBS_2Syst_F16* __u1BUS = (SWLIBS_2Syst_F16*)calloc(sizeof(SWLIBS_2Syst_F16), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
        ...
        {
            SWLIBS_2Syst_F16* __u2BUS = (SWLIBS_2Syst_F16*)calloc(sizeof(SWLIBS_2Syst_F16), ssGetInputPortWidth(S, 1));
            if (__u2BUS==NULL) {
        ...
        {
            AMCLIB_BEMF_OBSRV_DQ_T_F16* __work1BUS = (AMCLIB_BEMF_OBSRV_DQ_T_F16*)calloc(sizeof(AMCLIB_BEMF_OBSRV_DQ_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int16_T* p12 = (int16_T*) ssGetRunTimeParamInfo(S, 11)->data;
        int16_T* p13 = (int16_T*) ssGetRunTimeParamInfo(S, 12)->data;
        ...
        AMCLIB_BEMF_OBSRV_DQ_T_F16* __work1BUS = (AMCLIB_BEMF_OBSRV_DQ_T_F16*) ssGetPWorkValue(S, 2);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].pEObsrv.f16Arg1, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].pEObsrv.f16Arg2, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        ...
        (void) memcpy(&__work1BUS[0].pParamD.f16CC1sc, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].pParamD.f16CC2sc, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].pParamD.f32Acc, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].pParamD.f16InErrK1, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work1BUS[0].pParamD.f16UpperLimit, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work1BUS[0].pParamD.f16LowerLimit, work1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work1BUS[0].pParamD.u16NShift, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(&__work1BUS[0].pParamQ.f16CC1sc, work1 +  __dtBusInfo[26],  __dtBusInfo[27]);
        (void) memcpy(&__work1BUS[0].pParamQ.f16CC2sc, work1 +  __dtBusInfo[28],  __dtBusInfo[29]);
        (void) memcpy(&__work1BUS[0].pParamQ.f32Acc, work1 +  __dtBusInfo[30],  __dtBusInfo[31]);
        (void) memcpy(&__work1BUS[0].pParamQ.f16InErrK1, work1 +  __dtBusInfo[32],  __dtBusInfo[33]);
        (void) memcpy(&__work1BUS[0].pParamQ.f16UpperLimit, work1 +  __dtBusInfo[34],  __dtBusInfo[35]);
        (void) memcpy(&__work1BUS[0].pParamQ.f16LowerLimit, work1 +  __dtBusInfo[36],  __dtBusInfo[37]);
        ...
        (void) memcpy(&__work1BUS[0].f16IGain, work1 +  __dtBusInfo[48],  __dtBusInfo[49]);
        (void) memcpy(&__work1BUS[0].f16UGain, work1 +  __dtBusInfo[50],  __dtBusInfo[51]);
        (void) memcpy(&__work1BUS[0].f16WIGain, work1 +  __dtBusInfo[52],  __dtBusInfo[53]);
        (void) memcpy(&__work1BUS[0].f16EGain, work1 +  __dtBusInfo[54],  __dtBusInfo[55]);
        (void) memcpy(&__work1BUS[0].s16Shift, work1 +  __dtBusInfo[56],  __dtBusInfo[57]);

        /* Call the legacy code function */
        AMCLIB_BemfObsrvDQInit_w_F16(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p2);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].pEObsrv.f16Arg1,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].pEObsrv.f16Arg2,  __dtBusInfo[7]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].pParamD.f16CC1sc,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].pParamD.f16CC2sc,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].pParamD.f32Acc,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].pParamD.f16InErrK1,  __dtBusInfo[19]);
        (void) memcpy(work1 +  __dtBusInfo[20], &__work1BUS[0].pParamD.f16UpperLimit,  __dtBusInfo[21]);
        (void) memcpy(work1 +  __dtBusInfo[22], &__work1BUS[0].pParamD.f16LowerLimit,  __dtBusInfo[23]);
        (void) memcpy(work1 +  __dtBusInfo[24], &__work1BUS[0].pParamD.u16NShift,  __dtBusInfo[25]);
        (void) memcpy(work1 +  __dtBusInfo[26], &__work1BUS[0].pParamQ.f16CC1sc,  __dtBusInfo[27]);
        (void) memcpy(work1 +  __dtBusInfo[28], &__work1BUS[0].pParamQ.f16CC2sc,  __dtBusInfo[29]);
        (void) memcpy(work1 +  __dtBusInfo[30], &__work1BUS[0].pParamQ.f32Acc,  __dtBusInfo[31]);
        (void) memcpy(work1 +  __dtBusInfo[32], &__work1BUS[0].pParamQ.f16InErrK1,  __dtBusInfo[33]);
        (void) memcpy(work1 +  __dtBusInfo[34], &__work1BUS[0].pParamQ.f16UpperLimit,  __dtBusInfo[35]);
        (void) memcpy(work1 +  __dtBusInfo[36], &__work1BUS[0].pParamQ.f16LowerLimit,  __dtBusInfo[37]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[48], &__work1BUS[0].f16IGain,  __dtBusInfo[49]);
        (void) memcpy(work1 +  __dtBusInfo[50], &__work1BUS[0].f16UGain,  __dtBusInfo[51]);
        (void) memcpy(work1 +  __dtBusInfo[52], &__work1BUS[0].f16WIGain,  __dtBusInfo[53]);
        (void) memcpy(work1 +  __dtBusInfo[54], &__work1BUS[0].f16EGain,  __dtBusInfo[55]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_F16* __u1BUS = (SWLIBS_2Syst_F16*) ssGetPWorkValue(S, 0);
        SWLIBS_2Syst_F16* __u2BUS = (SWLIBS_2Syst_F16*) ssGetPWorkValue(S, 1);
        AMCLIB_BEMF_OBSRV_DQ_T_F16* __work1BUS = (AMCLIB_BEMF_OBSRV_DQ_T_F16*) ssGetPWorkValue(S, 2);
        ...
        (void) memcpy(&__u2BUS[0].f16Arg1, u2 +  __dtBusInfo[0],  __dtBusInfo[1]);
        (void) memcpy(&__u2BUS[0].f16Arg2, u2 +  __dtBusInfo[2],  __dtBusInfo[3]);
        ...
        /* Call the legacy code function */
        *y1 = AMCLIB_BemfObsrvDQ_w_F16(__u1BUS, __u2BUS, *u3, *u4, __work1BUS, work2, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, *u17, *u18, *u19, *u20, *u21, *u22, *u23, *u24, *u25, *u26, *u27, *u28, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, *p1, *p2);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'AMCLIB_BEMF_OBSRV_DQ_T_F16', specification */
    {
        uint32_T chk[] = {2050117353, 1454399816, 3725768057, 3191262725};
        int_T status;
        status = CheckDataTypeChecksum(S, "AMCLIB_BEMF_OBSRV_DQ_T_F16", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'AMCLIB_BEMF_OBSRV_DQ_T_F16'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'AMCLIB_BEMF_OBSRV_DQ_T_F16' definition has changed since the S-Function was generated");
        }
    }
