/**
 * AMCLIB_CurrentLoop_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_CurrentLoop_w_F32(int32 u1, GFLIB_CONTROLLER_PIAW_R_T_F32 work1[1], GFLIB_CONTROLLER_PIAW_R_T_F32 work2[1], SWLIBS_2Syst_F32 u2[1], SWLIBS_2Syst_F32 u3[1], int32 work3[1], int32 u4, int32 u5, int32 u6, int32 u7, uint16 u8, int32 u9, int32 u10, uint16 u11, int32 u12, int32 u13, int32 u14, int32 u15, SWLIBS_2Syst_F32 y1[1], int32 y2[1], int32 y3[1], int32 y4[1], int32 y5[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:57:00
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_CurrentLoop_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_CurrentLoopInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_CurrentLoop_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoop_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id);
        ...
        {
            GFLIB_CONTROLLER_PIAW_R_T_F32* __work2BUS = (GFLIB_CONTROLLER_PIAW_R_T_F32*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_R_T_F32), ssGetDWorkWidth(S, 1));
            if (__work2BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PIAW_R_T_F32* __work1BUS = (GFLIB_CONTROLLER_PIAW_R_T_F32*) ssGetPWorkValue(S, 3);
        GFLIB_CONTROLLER_PIAW_R_T_F32* __work2BUS = (GFLIB_CONTROLLER_PIAW_R_T_F32*) ssGetPWorkValue(S, 4);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f32CC1sc, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].f32CC2sc, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].f32Acc, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].f32InErrK1, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work1BUS[0].f32UpperLimit, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        ...
        (void) memcpy(&__work2BUS[0].f32CC1sc, work2 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work2BUS[0].f32CC2sc, work2 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work2BUS[0].f32Acc, work2 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work2BUS[0].f32InErrK1, work2 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work2BUS[0].f32UpperLimit, work2 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work2BUS[0].f32LowerLimit, work2 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work2BUS[0].u16NShift, work2 +  __dtBusInfo[16],  __dtBusInfo[17]);

        /* Call the legacy code function */
        AMCLIB_CurrentLoopInit_w_F32(__work1BUS, __work2BUS, work3, *p3, *p4, *p5, *p6, *p7, *p8, *p2);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f32CC1sc,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f32CC2sc,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].f32Acc,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].f32InErrK1,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].f32UpperLimit,  __dtBusInfo[13]);
        ...
        (void) memcpy(work2 +  __dtBusInfo[4], &__work2BUS[0].f32CC1sc,  __dtBusInfo[5]);
        (void) memcpy(work2 +  __dtBusInfo[6], &__work2BUS[0].f32CC2sc,  __dtBusInfo[7]);
        (void) memcpy(work2 +  __dtBusInfo[8], &__work2BUS[0].f32Acc,  __dtBusInfo[9]);
        (void) memcpy(work2 +  __dtBusInfo[10], &__work2BUS[0].f32InErrK1,  __dtBusInfo[11]);
        (void) memcpy(work2 +  __dtBusInfo[12], &__work2BUS[0].f32UpperLimit,  __dtBusInfo[13]);
        (void) memcpy(work2 +  __dtBusInfo[14], &__work2BUS[0].f32LowerLimit,  __dtBusInfo[15]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_F32* __u3BUS = (SWLIBS_2Syst_F32*) ssGetPWorkValue(S, 2);
        ...
        /* Call the legacy code function */
        AMCLIB_CurrentLoop_w_F32(*u1, __work1BUS, __work2BUS, __u2BUS, __u3BUS, work3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, __y1BUS, y2, y3, y4, y5, *p1, *p2);
