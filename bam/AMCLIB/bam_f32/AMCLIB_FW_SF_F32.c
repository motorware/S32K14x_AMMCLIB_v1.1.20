 ...
 *
 *         void AMCLIB_FW_w_F32(int32 u1, int32 u2, SWLIBS_2Syst_F32 work1[1], GDFLIB_FILTER_MA_T_F32 work2[1], GFLIB_CONTROLLER_PIAW_P_T_F32 work3[1], int32 work4[1], int32 u3[1], int32 u4[1], int32 u5[1], int32 u6, int32  u7, uint16 u8, int32  u9, int32  u10, int16  u11, int16  u12, int32  u13, int32  u14, int32  u15, int32  u16, int32  u17, int32  u18, SWLIBS_2Syst_F32 y1[1], uint16 y2[1], int32 y3[1], int32 y4[1], int32 y5[1], int32 y6[1], int32 y7[1], int32 y8[1], int32 y9[1], int32 y10[1], int32 y11[1], int32 y12[1], int32 y13[1], int32 p1, int32 p2, int32 p3)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:58:38
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_FW_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_FWInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_FW_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FWInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FW_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FW_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FW_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        {
            GFLIB_CONTROLLER_PIAW_P_T_F32* __work3BUS = (GFLIB_CONTROLLER_PIAW_P_T_F32*)calloc(sizeof(GFLIB_CONTROLLER_PIAW_P_T_F32), ssGetDWorkWidth(S, 2));
            if (__work3BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GFLIB_CONTROLLER_PIAW_P_T_F32* __work3BUS = (GFLIB_CONTROLLER_PIAW_P_T_F32*) ssGetPWorkValue(S, 3);
        ...
        (void) memcpy(&__work3BUS[0].f32PropGain, work3 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work3BUS[0].f32IntegGain, work3 +  __dtBusInfo[10],  __dtBusInfo[11]);
        ...
        (void) memcpy(&__work3BUS[0].f32LowerLimit, work3 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work3BUS[0].f32UpperLimit, work3 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work3BUS[0].f32IntegPartK_1, work3 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work3BUS[0].f32InK_1, work3 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work3BUS[0].u16LimitFlag, work3 +  __dtBusInfo[24],  __dtBusInfo[25]);

        /* Call the legacy code function */
        AMCLIB_FWInit_w_F32(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p1, *p2, *p3);
        ...
        (void) memcpy(work3 +  __dtBusInfo[8], &__work3BUS[0].f32PropGain,  __dtBusInfo[9]);
        (void) memcpy(work3 +  __dtBusInfo[10], &__work3BUS[0].f32IntegGain,  __dtBusInfo[11]);
        ...
        (void) memcpy(work3 +  __dtBusInfo[16], &__work3BUS[0].f32LowerLimit,  __dtBusInfo[17]);
        (void) memcpy(work3 +  __dtBusInfo[18], &__work3BUS[0].f32UpperLimit,  __dtBusInfo[19]);
        (void) memcpy(work3 +  __dtBusInfo[20], &__work3BUS[0].f32IntegPartK_1,  __dtBusInfo[21]);
        (void) memcpy(work3 +  __dtBusInfo[22], &__work3BUS[0].f32InK_1,  __dtBusInfo[23]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_FW_w_F32(*u1, *u2, __work1BUS, __work2BUS, __work3BUS, work4, u3, u4, u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, *u17, *u18, __y1BUS, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, *p1, *p2, *p3);
