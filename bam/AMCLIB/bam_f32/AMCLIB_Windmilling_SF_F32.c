/**
 * AMCLIB_Windmilling_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         uint32 y1 = AMCLIB_Windmilling_w_F32(SWLIBS_3Syst_F32 u1[1], AMCLIB_WINDMILLING_T_F32 work1[1], int32 u2, int32 u3, int32 u4, int32 u5, int32 u6, uint16 u7, int32 u8, uint16 u9, int32 u10, int32 u11, int32 u12, int32 u13, int32 y2[1], int32 y3[1], int32 y4[1], int32 y5[1], int32 y6[1], int32 y7[1], int32 p1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:00:02
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_Windmilling_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_WINDMILLING_T_F32", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_WindmillingInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_Windmilling_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_WindmillingInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __AMCLIB_WINDMILLING_T_F32Id = ssGetDataTypeId(S, "AMCLIB_WINDMILLING_T_F32");
        DTypeId __AMCLIB_TRACK_OBSRV_T_F32Id = ssGetDataTypeId(S, "AMCLIB_TRACK_OBSRV_T_F32");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __AMCLIB_WINDMILLING_T_F32Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __AMCLIB_TRACK_OBSRV_T_F32Id);
        __dtSizeInfo[4] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id);
        __dtSizeInfo[5] = ssGetDataTypeSize(S, __uint16Id);
        __dtSizeInfo[6] = ssGetDataTypeSize(S, __GFLIB_INTEGRATOR_TR_T_F32Id);
        __dtSizeInfo[7] = ssGetDataTypeSize(S, __GDFLIB_FILTER_MA_T_F32Id);
        __dtSizeInfo[8] = ssGetDataTypeSize(S, __uint8Id);
        ...
        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.f32ADCComp */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 0);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32CC1sc */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 0);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32CC2sc */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 1);
        __dtBusInfo[11] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32Acc */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 2);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32InErrK1 */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 3);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32UpperLimit */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 4);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.f32LowerLimit */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 5);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamPI.u16NShift */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 6);
        __dtBusInfo[21] = __dtSizeInfo[5];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamInteg.f32State */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 0);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamInteg.f32InK1 */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 1);
        __dtBusInfo[25] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamInteg.f32C1 */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 2);
        __dtBusInfo[27] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pParamATO.pParamInteg.u16NShift */
        __dtBusInfo[28] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 3);
        __dtBusInfo[29] = __dtSizeInfo[5];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pDetMA.f32Acc */
        __dtBusInfo[30] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 2) + ssGetBusElementOffset(S, __GDFLIB_FILTER_MA_T_F32Id, 0);
        __dtBusInfo[31] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.pDetMA.u16NSamples */
        __dtBusInfo[32] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 2) + ssGetBusElementOffset(S, __GDFLIB_FILTER_MA_T_F32Id, 1);
        __dtBusInfo[33] = __dtSizeInfo[5];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.u8DetNoiseCnt */
        __dtBusInfo[34] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 3);
        __dtBusInfo[35] = __dtSizeInfo[8];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.u8DetSpin */
        __dtBusInfo[36] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 4);
        __dtBusInfo[37] = __dtSizeInfo[8];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.u16DetHystCnt */
        __dtBusInfo[38] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 5);
        __dtBusInfo[39] = __dtSizeInfo[5];

        /* Get information for accessing AMCLIB_WINDMILLING_T_F32.u16DetStopCnt */
        __dtBusInfo[40] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_F32Id, 6);
        __dtBusInfo[41] = __dtSizeInfo[5];


        /* Alloc memory for the pwork 1 (__u1BUS) */
        {
            SWLIBS_3Syst_F32* __u1BUS = (SWLIBS_3Syst_F32*)calloc(sizeof(SWLIBS_3Syst_F32), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
        ...
        {
            AMCLIB_WINDMILLING_T_F32* __work1BUS = (AMCLIB_WINDMILLING_T_F32*)calloc(sizeof(AMCLIB_WINDMILLING_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        AMCLIB_WINDMILLING_T_F32* __work1BUS = (AMCLIB_WINDMILLING_T_F32*) ssGetPWorkValue(S, 1);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f32ADCComp, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32CC1sc, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32CC2sc, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32Acc, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32InErrK1, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32UpperLimit, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.f32LowerLimit, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        ...
        (void) memcpy(&__work1BUS[0].pParamATO.pParamInteg.f32InK1, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamInteg.f32C1, work1 +  __dtBusInfo[26],  __dtBusInfo[27]);
        ...
        AMCLIB_WindmillingInit_w_F32(__work1BUS, *p2, *p3, *p4, *p5, *p6, *p7, *p8, *p9);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f32ADCComp,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].pParamATO.pParamPI.f32CC1sc,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].pParamATO.pParamPI.f32CC2sc,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].pParamATO.pParamPI.f32Acc,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].pParamATO.pParamPI.f32InErrK1,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].pParamATO.pParamPI.f32UpperLimit,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].pParamATO.pParamPI.f32LowerLimit,  __dtBusInfo[19]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[24], &__work1BUS[0].pParamATO.pParamInteg.f32InK1,  __dtBusInfo[25]);
        (void) memcpy(work1 +  __dtBusInfo[26], &__work1BUS[0].pParamATO.pParamInteg.f32C1,  __dtBusInfo[27]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_3Syst_F32* __u1BUS = (SWLIBS_3Syst_F32*) ssGetPWorkValue(S, 0);
        AMCLIB_WINDMILLING_T_F32* __work1BUS = (AMCLIB_WINDMILLING_T_F32*) ssGetPWorkValue(S, 1);
        ...
        (void) memcpy(&__u1BUS[0].f32Arg3, u1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        ...
        /* Call the legacy code function */
        *y1 = AMCLIB_Windmilling_w_F32(__u1BUS, __work1BUS, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, y2, y3, y4, y5, y6, y7, *p1);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'AMCLIB_WINDMILLING_T_F32', specification */
    {
        uint32_T chk[] = {610189331, 72391910, 392662536, 1742137136};
        int_T status;
        status = CheckDataTypeChecksum(S, "AMCLIB_WINDMILLING_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'AMCLIB_WINDMILLING_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'AMCLIB_WINDMILLING_T_F32' definition has changed since the S-Function was generated");
        }
    }

    /* Verify Bus/StructType 'AMCLIB_TRACK_OBSRV_T_F32', specification */
    {
        uint32_T chk[] = {3509851748, 194937212, 3163453824, 2137044371};
        int_T status;
        status = CheckDataTypeChecksum(S, "AMCLIB_TRACK_OBSRV_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'AMCLIB_TRACK_OBSRV_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'AMCLIB_TRACK_OBSRV_T_F32' definition has changed since the S-Function was generated");
        }
    }
