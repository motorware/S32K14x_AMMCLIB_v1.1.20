/**
 * AMCLIB_TrackObsrv_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_TrackObsrv_w_F32(int32 u1, int32 u2, int32 u3, AMCLIB_TRACK_OBSRV_T_F32 work1[1], int32 work2[1], int32 u4, int32 u5, int32 u6, int32 u7, uint16 u8, int32 u9, uint16 u10, int32 u11, int32 u12, int32 u13, int32 u14, int32 y1[1], int32 y2[1], int32 y3[1], int32 y4[1], int32 y5[1], int32 y6[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 20:59:46
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_TrackObsrv_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_TRACK_OBSRV_T_F32", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_TrackObsrvInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_TrackObsrv_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_TrackObsrvInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_TrackObsrv_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_TrackObsrv_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_TrackObsrv_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __AMCLIB_TRACK_OBSRV_T_F32Id);
        __dtSizeInfo[1] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id);
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __int32Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __uint16Id);
        __dtSizeInfo[4] = ssGetDataTypeSize(S, __GFLIB_INTEGRATOR_TR_T_F32Id);

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32CC1sc */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 0);
        __dtBusInfo[1] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32CC2sc */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 1);
        __dtBusInfo[3] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32Acc */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 2);
        __dtBusInfo[5] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32InErrK1 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 3);
        __dtBusInfo[7] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32UpperLimit */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 4);
        __dtBusInfo[9] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.f32LowerLimit */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 5);
        __dtBusInfo[11] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamPI.u16NShift */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_F32Id, 6);
        __dtBusInfo[13] = __dtSizeInfo[3];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamInteg.f32State */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 0);
        __dtBusInfo[15] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamInteg.f32InK1 */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 1);
        __dtBusInfo[17] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamInteg.f32C1 */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 2);
        __dtBusInfo[19] = __dtSizeInfo[2];

        /* Get information for accessing AMCLIB_TRACK_OBSRV_T_F32.pParamInteg.u16NShift */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_F32Id, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_F32Id, 3);
        __dtBusInfo[21] = __dtSizeInfo[3];


        /* Alloc memory for the pwork 1 (__work1BUS) */
        {
            AMCLIB_TRACK_OBSRV_T_F32* __work1BUS = (AMCLIB_TRACK_OBSRV_T_F32*)calloc(sizeof(AMCLIB_TRACK_OBSRV_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        AMCLIB_TRACK_OBSRV_T_F32* __work1BUS = (AMCLIB_TRACK_OBSRV_T_F32*) ssGetPWorkValue(S, 0);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].pParamPI.f32CC1sc, work1 +  __dtBusInfo[0],  __dtBusInfo[1]);
        (void) memcpy(&__work1BUS[0].pParamPI.f32CC2sc, work1 +  __dtBusInfo[2],  __dtBusInfo[3]);
        (void) memcpy(&__work1BUS[0].pParamPI.f32Acc, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].pParamPI.f32InErrK1, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].pParamPI.f32UpperLimit, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].pParamPI.f32LowerLimit, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        ...
        (void) memcpy(&__work1BUS[0].pParamInteg.f32InK1, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].pParamInteg.f32C1, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work1BUS[0].pParamInteg.u16NShift, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);

        /* Call the legacy code function */
        AMCLIB_TrackObsrvInit_w_F32(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p2);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[0], &__work1BUS[0].pParamPI.f32CC1sc,  __dtBusInfo[1]);
        (void) memcpy(work1 +  __dtBusInfo[2], &__work1BUS[0].pParamPI.f32CC2sc,  __dtBusInfo[3]);
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].pParamPI.f32Acc,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].pParamPI.f32InErrK1,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].pParamPI.f32UpperLimit,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].pParamPI.f32LowerLimit,  __dtBusInfo[11]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].pParamInteg.f32InK1,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].pParamInteg.f32C1,  __dtBusInfo[19]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_TrackObsrv_w_F32(*u1, *u2, *u3, __work1BUS, work2, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, y1, y2, y3, y4, y5, y6, *p1, *p2);
