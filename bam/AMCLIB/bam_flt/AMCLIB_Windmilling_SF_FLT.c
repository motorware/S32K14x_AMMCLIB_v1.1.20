/**
 * AMCLIB_Windmilling_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         uint32 y1 = AMCLIB_Windmilling_w_FLT(SWLIBS_3Syst_FLT u1[1], AMCLIB_WINDMILLING_T_FLT work1[1], single u2, single u3, single u4, single u5, single u6, single u7, single u8, single u9, single u10, single u11, single y2[1], single y3[1], single y4[1], single y5[1], single y6[1], single y7[1], int32 p1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 15-Apr-2020 21:00:11
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_Windmilling_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_WINDMILLING_T_FLT", &dataTypeIdReg);
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "SWLIBS_3Syst_FLT", &dataTypeIdReg);
        if(dataTypeIdReg == INVALID_DTYPE_ID) return;
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_WindmillingInit_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_Windmilling_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_WindmillingInit_w_FLT_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_Windmilling_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __SWLIBS_3Syst_FLTId = ssGetDataTypeId(S, "SWLIBS_3Syst_FLT");
        DTypeId __singleId = ssGetDataTypeId(S, "single");
        DTypeId __AMCLIB_WINDMILLING_T_FLTId = ssGetDataTypeId(S, "AMCLIB_WINDMILLING_T_FLT");
        ...
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __SWLIBS_3Syst_FLTId);
        __dtSizeInfo[1] = ssGetDataTypeSize(S, __singleId);
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __AMCLIB_WINDMILLING_T_FLTId);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __AMCLIB_TRACK_OBSRV_T_FLTId);
        __dtSizeInfo[4] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId);
        __dtSizeInfo[5] = ssGetDataTypeSize(S, __GFLIB_INTEGRATOR_TR_T_FLTId);
        __dtSizeInfo[6] = ssGetDataTypeSize(S, __GDFLIB_FILTER_MA_T_FLTId);
        __dtSizeInfo[7] = ssGetDataTypeSize(S, __uint8Id);
        __dtSizeInfo[8] = ssGetDataTypeSize(S, __uint16Id);

        /* Get information for accessing SWLIBS_3Syst_FLT.fltArg1 */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __SWLIBS_3Syst_FLTId, 0);
        __dtBusInfo[1] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_3Syst_FLT.fltArg2 */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __SWLIBS_3Syst_FLTId, 1);
        __dtBusInfo[3] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_3Syst_FLT.fltArg3 */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __SWLIBS_3Syst_FLTId, 2);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.fltADCComp */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 0);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltCC1sc */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 0);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltCC2sc */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 1);
        __dtBusInfo[11] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltAcc */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 2);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltInErrK1 */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 3);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltUpperLimit */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 4);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamPI.fltLowerLimit */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 0) + ssGetBusElementOffset(S, __GFLIB_CONTROLLER_PIAW_R_T_FLTId, 5);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamInteg.fltState */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_FLTId, 0);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamInteg.fltInK1 */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_FLTId, 1);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pParamATO.pParamInteg.fltC1 */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 1) + ssGetBusElementOffset(S, __AMCLIB_TRACK_OBSRV_T_FLTId, 1) + ssGetBusElementOffset(S, __GFLIB_INTEGRATOR_TR_T_FLTId, 2);
        __dtBusInfo[25] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pDetMA.fltAcc */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 2) + ssGetBusElementOffset(S, __GDFLIB_FILTER_MA_T_FLTId, 0);
        __dtBusInfo[27] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.pDetMA.fltLambda */
        __dtBusInfo[28] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 2) + ssGetBusElementOffset(S, __GDFLIB_FILTER_MA_T_FLTId, 1);
        __dtBusInfo[29] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.u8DetNoiseCnt */
        __dtBusInfo[30] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 3);
        __dtBusInfo[31] = __dtSizeInfo[7];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.u8DetSpin */
        __dtBusInfo[32] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 4);
        __dtBusInfo[33] = __dtSizeInfo[7];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.u16DetHystCnt */
        __dtBusInfo[34] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 5);
        __dtBusInfo[35] = __dtSizeInfo[8];

        /* Get information for accessing AMCLIB_WINDMILLING_T_FLT.u16DetStopCnt */
        __dtBusInfo[36] = ssGetBusElementOffset(S, __AMCLIB_WINDMILLING_T_FLTId, 6);
        __dtBusInfo[37] = __dtSizeInfo[8];


        /* Alloc memory for the pwork 1 (__u1BUS) */
        {
            SWLIBS_3Syst_FLT* __u1BUS = (SWLIBS_3Syst_FLT*)calloc(sizeof(SWLIBS_3Syst_FLT), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
        ...
        {
            AMCLIB_WINDMILLING_T_FLT* __work1BUS = (AMCLIB_WINDMILLING_T_FLT*)calloc(sizeof(AMCLIB_WINDMILLING_T_FLT), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        AMCLIB_WINDMILLING_T_FLT* __work1BUS = (AMCLIB_WINDMILLING_T_FLT*) ssGetPWorkValue(S, 1);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].fltADCComp, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltCC1sc, work1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltCC2sc, work1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltAcc, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltInErrK1, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltUpperLimit, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamPI.fltLowerLimit, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamInteg.fltState, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamInteg.fltInK1, work1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work1BUS[0].pParamATO.pParamInteg.fltC1, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(&__work1BUS[0].pDetMA.fltAcc, work1 +  __dtBusInfo[26],  __dtBusInfo[27]);
        (void) memcpy(&__work1BUS[0].pDetMA.fltLambda, work1 +  __dtBusInfo[28],  __dtBusInfo[29]);
        (void) memcpy(&__work1BUS[0].u8DetNoiseCnt, work1 +  __dtBusInfo[30],  __dtBusInfo[31]);
        (void) memcpy(&__work1BUS[0].u8DetSpin, work1 +  __dtBusInfo[32],  __dtBusInfo[33]);
        (void) memcpy(&__work1BUS[0].u16DetHystCnt, work1 +  __dtBusInfo[34],  __dtBusInfo[35]);
        (void) memcpy(&__work1BUS[0].u16DetStopCnt, work1 +  __dtBusInfo[36],  __dtBusInfo[37]);

        /* Call the legacy code function */
        AMCLIB_WindmillingInit_w_FLT(__work1BUS, *p2, *p3, *p4, *p5, *p6, *p7);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].fltADCComp,  __dtBusInfo[7]);
        (void) memcpy(work1 +  __dtBusInfo[8], &__work1BUS[0].pParamATO.pParamPI.fltCC1sc,  __dtBusInfo[9]);
        (void) memcpy(work1 +  __dtBusInfo[10], &__work1BUS[0].pParamATO.pParamPI.fltCC2sc,  __dtBusInfo[11]);
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].pParamATO.pParamPI.fltAcc,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].pParamATO.pParamPI.fltInErrK1,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].pParamATO.pParamPI.fltUpperLimit,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].pParamATO.pParamPI.fltLowerLimit,  __dtBusInfo[19]);
        (void) memcpy(work1 +  __dtBusInfo[20], &__work1BUS[0].pParamATO.pParamInteg.fltState,  __dtBusInfo[21]);
        (void) memcpy(work1 +  __dtBusInfo[22], &__work1BUS[0].pParamATO.pParamInteg.fltInK1,  __dtBusInfo[23]);
        (void) memcpy(work1 +  __dtBusInfo[24], &__work1BUS[0].pParamATO.pParamInteg.fltC1,  __dtBusInfo[25]);
        (void) memcpy(work1 +  __dtBusInfo[26], &__work1BUS[0].pDetMA.fltAcc,  __dtBusInfo[27]);
        (void) memcpy(work1 +  __dtBusInfo[28], &__work1BUS[0].pDetMA.fltLambda,  __dtBusInfo[29]);
        (void) memcpy(work1 +  __dtBusInfo[30], &__work1BUS[0].u8DetNoiseCnt,  __dtBusInfo[31]);
        (void) memcpy(work1 +  __dtBusInfo[32], &__work1BUS[0].u8DetSpin,  __dtBusInfo[33]);
        (void) memcpy(work1 +  __dtBusInfo[34], &__work1BUS[0].u16DetHystCnt,  __dtBusInfo[35]);
        (void) memcpy(work1 +  __dtBusInfo[36], &__work1BUS[0].u16DetStopCnt,  __dtBusInfo[37]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_3Syst_FLT* __u1BUS = (SWLIBS_3Syst_FLT*) ssGetPWorkValue(S, 0);
        AMCLIB_WINDMILLING_T_FLT* __work1BUS = (AMCLIB_WINDMILLING_T_FLT*) ssGetPWorkValue(S, 1);
        ...
        (void) memcpy(&__u1BUS[0].fltArg3, u1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        ...
        /* Call the legacy code function */
        *y1 = AMCLIB_Windmilling_w_FLT(__u1BUS, __work1BUS, *u2, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, y2, y3, y4, y5, y6, y7, *p1);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'SWLIBS_3Syst_FLT', specification */
    {
        uint32_T chk[] = {3474614162, 846256060, 1737667219, 3395743160};
        int_T status;
        status = CheckDataTypeChecksum(S, "SWLIBS_3Syst_FLT", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'SWLIBS_3Syst_FLT'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'SWLIBS_3Syst_FLT' definition has changed since the S-Function was generated");
        }
    }

    /* Verify Bus/StructType 'AMCLIB_WINDMILLING_T_FLT', specification */
    {
        uint32_T chk[] = {2255731763, 3102142430, 3188368952, 2408299319};
        int_T status;
        status = CheckDataTypeChecksum(S, "AMCLIB_WINDMILLING_T_FLT", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'AMCLIB_WINDMILLING_T_FLT'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'AMCLIB_WINDMILLING_T_FLT' definition has changed since the S-Function was generated");
        }
    }
